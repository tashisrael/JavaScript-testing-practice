...
**This is a simple project for JavaScript testing**
...
### Setup
- clone 'https://github.com/tashisrael/JavaScript-testing-practice.git'
...
Feel free to check the [issues page](https://github.com/tashisrael/JavaScript-testing-practice/issues).
